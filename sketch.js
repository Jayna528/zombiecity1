...
Enemy1.velocityX = -4
Enemy1.velocityY = 4
Enemy2 = createSprite(210,300);
Enemy2.addImage(zombie_img2);
Enemy2.scale = 0.2;
Enemy2.velocityX = 4
Enemy2.velocityY = 4
Enemy3 = createSprite(270,500);
...
//create coins
coin1 = createSprite(300,300)
coin1.addImage(coin);
coin1.scale = 0.2
coin2 = createSprite(300,300)
coin2.addImage(coin);
coin2.scale = 0.2
coin3 = createSprite(300,300)
coin3.addImage(coin);
coin3.scale = 0.2
coin4 = createSprite(300,300)
coin4.addImage(coin);
coin4.scale = 0.2
coin5 = createSprite(300,300)
coin5.addImage(coin);
coin5.scale = 0.2
coin6 = createSprite(300,300)
coin6.addImage(coin);
coin6.scale = 0.2
coin7 = createSprite(300,300)
coin7.addImage(coin);
coin7.scale = 0.2
coin8 = createSprite(300,300)
coin8.addImage(coin);
coin8.scale = 0.2
coin9 = createSprite(300,300)
coin9.addImage(coin);
coin9.scale = 0.2
coin10 = createSprite(300,300)
